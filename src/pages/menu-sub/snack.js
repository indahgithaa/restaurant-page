export default function snacksMenu() {
    ...
    let snacksArr = [
        ...
        new Snacks('Mixed Fruits Pie', 'A slice of soft and naturally sweetened pie made from self-raising flour, topped with homemade berry jam and mixed seasonal fruits. <br/><br/>Gluten-free', '$6.00'),
    ]
